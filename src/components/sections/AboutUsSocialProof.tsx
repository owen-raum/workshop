export function AboutUsSocialProof() {
  return (
    <section id="about" className="py-20 md:py-32 lg:py-40 px-4 bg-navy-600">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            {/* Andy Card */}
            <div className="bg-navy-700 rounded-2xl p-8 md:p-10 border border-navy-500">
              <div className="flex flex-col sm:flex-row gap-6 items-start">
                {/* Avatar */}
                <div className="flex-shrink-0 mx-auto sm:mx-0">
                  <div className="w-28 h-28 rounded-2xl border border-navy-500 bg-orange-100 flex items-center justify-center">
              ...
              {/* Credibility Links */}
              <div className="mt-6 pt-6 border-t border-navy-600 grid grid-cols-2 gap-3">
                <a href="https://pulse.how" target="_blank" rel="noopener" className="text-center py-3 px-4 bg-navy-800 rounded-lg border border-navy-600 hover:border-orange-400 transition-colors group">
                  <div className="font-display font-bold text-white text-sm group-hover:text-orange-400 transition-colors">The Circle</div>
                  <div className="text-slate-300 text-xs">AI Community</div>
                </a>
                <a href="https://raum.so" target="_blank" rel="noopener" className="text-center py-3 px-4 bg-navy-800 rounded-lg border border-navy-600 hover:border-orange-400 transition-colors group">
                  <div className="font-display font-bold text-white text-sm group-hover:text-orange-400 transition-colors">[ʁaʊ̯m̩]</div>
                  <div className="text-slate-300 text-xs">Consulting</div>
                </a>
              </div>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="bg-navy-700 rounded-xl p-6 border border-navy-500">
                <div className="flex items-start gap-4">
                  <div className="text-2xl flex-shrink-0">🎯</div>
                  <div>
                    <h4 className="font-display font-bold text-white mb-2">Kein Bullshit</h4>
              ...
              <div className="bg-navy-700 rounded-xl p-6 border border-navy-500">
                <div className="flex items-start gap-4">
                  <div className="text-2xl flex-shrink-0">🔧</div>
                  <div>
                    <h4 className="font-display font-bold text-white mb-2">Echte Praxis</h4>
                    <p className="text-slate-200 text-sm leading-relaxed">
              ...
              <div className="bg-navy-700 rounded-xl p-6 border border-navy-500">
                <div className="flex items-start gap-4">
                  <div className="text-2xl flex-shrink-0">💬</div>
                  <div>
                    <h4 className="font-display font-bold text-white mb-2">Direkte Linie</h4>
                    <p className="text-slate-200 text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-navy-700 rounded-xl p-6 border border-navy-500 text-center">
                <div className="font-display font-bold text-white text-xl">50k+</div>
                <div className="text-slate-200 text-sm">Tasks von Owen</div>
              </div>
              <div className="bg-navy-700 rounded-xl p-6 border border-navy-500 text-center">
                <div className="font-display font-bold text-white text-xl">Seit 2021</div>
                <div className="text-slate-200 text-sm">Owen im Einsatz</div>
              </div>
            </div>
          </div>
        </div>
