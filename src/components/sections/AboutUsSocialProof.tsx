export function AboutUsSocialProof() {
  return (
    <section id="about" className="py-20 md:py-32 lg:py-40 px-4 bg-slate-50">
            ...
            <div className="bg-slate-50 rounded-2xl p-8 md:p-10 border border-slate-200">
              <div className="flex flex-col sm:flex-row gap-6 items-start">
                ...
                <div className="flex-shrink-0 mx-auto sm:mx-0">
                  <div className="w-28 h-28 rounded-2xl border border-slate-300 bg-orange-100 flex items-center justify-center">
              ...
              <div className="mt-6 pt-6 border-t border-slate-200 grid grid-cols-2 gap-3">
                <a href="https://pulse.how" target="_blank" rel="noopener" className="text-center py-3 px-4 bg-white rounded-lg border border-slate-200 hover:border-orange-300 transition-colors group">
                ...
                <a href="https://raum.so" target="_blank" rel="noopener" className="text-center py-3 px-4 bg-white rounded-lg border border-slate-200 hover:border-orange-300 transition-colors group">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-slate-50 rounded-xl p-6 border border-slate-200 text-center">
                ...
                <div className="text-slate-600 text-sm">Tasks von Owen</div>
              </div>
              <div className="bg-slate-50 rounded-xl p-6 border border-slate-200 text-center">
                <div className="font-display font-bold text-slate-900 text-xl">Seit 2021</div>
                <div className="text-slate-600 text-sm">Owen im Einsatz</div>
              </div>
            </div>
          </div>
        </div>
