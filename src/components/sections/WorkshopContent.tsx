      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-4 md:space-y-6">
          {modules.map((module, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl p-6 md:p-8 border border-slate-200 hover:border-orange-300 hover:shadow-lg transition-all"
            >
              <div className="flex items-start gap-4 md:gap-6">
                <div className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 bg-orange-200 rounded-xl flex items-center justify-center text-orange-800 font-bold text-lg md:text-xl">
                  {index + 1}
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <ul className="space-y-2">
                    {module.points.map((point, pointIndex) => (
                      <li key={pointIndex} className="flex items-start gap-2 md:gap-3 text-slate-600 text-sm md:text-base">
        ...
        <div className="mt-12 bg-slate-100 rounded-2xl p-6 md:p-8 border border-slate-200">
