export function WorkshopContent() {
  ...
  return (
    <section id="content" className="py-20 md:py-32 lg:py-40 px-4 bg-navy-600">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="font-display text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-4 md:mb-6 px-2">
            90 Minuten. Kein Hype.
          </h2>
          <p className="text-lg md:text-xl lg:text-2xl text-slate-200 max-w-3xl mx-auto leading-relaxed px-4">
        ...
        <div className="space-y-4 md:space-y-6">
          {modules.map((module, index) => (
            <div
              key={index}
              className="bg-navy-700 rounded-2xl p-6 md:p-8 border border-navy-500 hover:border-orange-400 hover:shadow-lg transition-all"
            >
              <div className="flex items-start gap-4 md:gap-6">
                <div className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 bg-orange-600 rounded-xl flex items-center justify-center text-white font-bold text-lg md:text-xl">
                  {index + 1}
                </div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3 md:mb-4 gap-2">
                    ...
                    <span className="text-xs md:text-sm font-medium text-slate-300 bg-navy-800 px-3 py-1 rounded-full self-start">
                      {module.duration}
                    </span>
                  </div>
                  ...
                  <ul className="space-y-2">
                    {module.points.map((point, pointIndex) => (
                      <li key={pointIndex} className="flex items-start gap-2 md:gap-3 text-slate-200 text-sm md:text-base">
                        <svg className="w-4 h-4 md:w-5 md:h-5 text-orange-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-12 bg-navy-700 rounded-2xl p-6 md:p-8 border border-navy-500">
