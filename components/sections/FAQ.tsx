...
export function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Live-Session am 15. März um 19:00 Uhr (90 Minuten). Ich zeige dir Owen in Action – echte Demos, was alles möglich ist, wo es hakt. Keine Installation, keine Anleitung. Q&A am Ende. Kein Verkaufs-Pitch.',
    },
    {
